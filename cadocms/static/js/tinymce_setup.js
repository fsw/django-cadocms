...
tinyMCE.init({
    ...
    theme_advanced_buttons2: 'search,|,pasteword,template,media,charmap,|,code,|, outdent, indent, justifyleft, justifycenter, justifyright, justifyfull, sub,sup, |,table,cleanup,grappelli_documentstructure',
